package com.wmods.tiktokenhancer.xposed.bridge;
        ...
        XposedBridge.hookMethod(mCall, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                try {
                    ...
                    if ("TikTokEnhancer".equals(method)) {
                        if ("getHookBinder".equals(arg)) {
                            ...
                            XposedBridge.log("TikTokEnhancer: Trying to allow blocking ");
                            try {
                            ...
                            XposedBridge.log("TikTokEnhancer: Bypass Scope using Provider Settings");
                        }
                    }
                } catch (Throwable ex) {
                    XposedBridge.log(ex);
