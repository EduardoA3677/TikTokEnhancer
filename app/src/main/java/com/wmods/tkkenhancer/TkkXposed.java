...
import com.wmods.tkkenhancer.xposed.AntiUpdater;
import com.wmods.tkkenhancer.xposed.bridge.ScopeHook;
import com.wmods.tkkenhancer.xposed.core.FeatureLoader;
import com.wmods.tkkenhancer.xposed.downgrade.Patch;
...
public class TkkXposed implements IXposedHookLoadPackage, IXposedHookInitPackageResources, IXposedHookZygoteInit {
