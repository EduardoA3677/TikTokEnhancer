...
import static com.wmods.tkkenhancer.xposed.features.customization.IGStatus.itens;
...
import com.wmods.tkkenhancer.views.dialog.TabDialogContent;
...
public class IGStatusAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.setOnClickListener(v -> {
            if (holder.myStatus) {
                ...
                var dialog = TkkCore.createBottomDialog(activity);
                ...
                tabdialog.addTab(UnobfuscatorCache.getInstance().getString("mystatus"), DesignUtils.getIconByName("ic_status", true), (view) -> {
                    try {
                        ...
                        var intent = new Intent(TkkCore.getCurrentActivity(), clazz);
    ...
    class IGStatusViewHolder {
        ...
        private FMessageTkk.UserJid userJid;
        ...
        public void setInfo(Object item) {
            ...
            if (Objects.equals(item, "my_status")) {
                ...
                var profile = TkkCore.getMyPhoto();
                if (profile == null)
            ...
            try {
                ...
                this.userJid = new FMessageTkk.UserJid(ReflectionUtils.getObjectField(field, statusInfo));
                var contactName = TkkCore.getContactName(this.userJid);
                igStatusContactName.setText(contactName);
                var profile = TkkCore.getContactPhotoDrawable(this.userJid.getPhoneRawString());
                if (profile == null)
                    profile = Utils.getApplication().getDrawable(ResId.drawable.user_foreground);
                igStatusContactPhoto.setImageDrawable(profile);
