package com.wmods.tkkenhancer.views;
...
public class WallpaperView extends FrameLayout {
    ...
    private Drawable getDrawableImage(String imagePath) throws Exception {
        ...
        String cachedData = TkkCore.getPrivString("wallpaper_data", "");
        ...
        Bitmap bitmap;
        if (!file.canRead()) {
            var parcelFile = TkkCore.getClientBridge().openFile(filePath, false);
        ...
        TkkCore.setPrivString("wallpaper_data", cacheKey);
        bitmap.recycle();
