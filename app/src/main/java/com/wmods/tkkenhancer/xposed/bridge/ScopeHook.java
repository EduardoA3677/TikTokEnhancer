package com.wmods.tkkenhancer.xposed.bridge;
                ...
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    try {
                        ...
                        for (var caller : callingApps) {
                            if ((caller.equals(FeatureLoader.PACKAGE_TKK) || caller.equals(FeatureLoader.PACKAGE_BUSINESS)) && targetApp.equals(BuildConfig.APPLICATION_ID)) {
