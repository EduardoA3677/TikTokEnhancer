...
import com.wmods.tkkenhancer.activities.ForceStartActivity;
import com.wmods.tkkenhancer.xposed.bridge.TkeIIFace;
import com.wmods.tkkenhancer.xposed.bridge.service.BridgeService;
...
public class BridgeClient extends BaseClient implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        this.service = TkeIIFace.Stub.asInterface(service);
