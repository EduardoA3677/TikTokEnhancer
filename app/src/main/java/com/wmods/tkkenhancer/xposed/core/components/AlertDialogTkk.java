...
public class AlertDialogTkk {
    ...
    public AlertDialogTkk(Context context) {
        mContext = context;
        if (isSystemDialog()) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to create AlertDialogTkk");
        }
    }
    ...
    public AlertDialogTkk setTitle(String title) {
        if (isSystemDialog()) {
    ...
    public AlertDialogTkk setTitle(int title) {
        if (isSystemDialog()) {
            mAlertDialog.setTitle(title);
            return this;
        }
    ...
    public AlertDialogTkk setMessage(String message) {
        if (isSystemDialog()) {
    ...
    public AlertDialogTkk setItems(CharSequence[] items, DialogInterface.OnClickListener listener) {
        if (isSystemDialog()) {
    ...
    public AlertDialogTkk setMultiChoiceItems(CharSequence[] items, boolean[] checkedItems, DialogInterface.OnMultiChoiceClickListener listener) {
        if (isSystemDialog()) {
    ...
    public AlertDialogTkk setNegativeButton(CharSequence text, DialogInterface.OnClickListener listener) {
        if (isSystemDialog()) {
    ...
    public AlertDialogTkk setPositiveButton(CharSequence text, DialogInterface.OnClickListener listener) {
        if (isSystemDialog()) {
    ...
    public AlertDialogTkk setView(View view) {
        if (isSystemDialog()) {
