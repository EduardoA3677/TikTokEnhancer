package com.wmods.tkkenhancer.xposed.features.customization;

import static com.wmods.tkkenhancer.utils.ColorReplacement.replaceColors;
import static com.wmods.tkkenhancer.utils.DrawableColors.replaceColor;
import static com.wmods.tkkenhancer.utils.IColors.alphacolors;
import static com.wmods.tkkenhancer.utils.IColors.backgroundColors;
import static com.wmods.tkkenhancer.utils.IColors.primaryColors;
import static com.wmods.tkkenhancer.utils.IColors.textColors;
...
import com.wmods.tkkenhancer.utils.IColors;
import com.wmods.tkkenhancer.views.WallpaperView;
...
//    private ViewGroup mContent;
    ...
    private void hookWallpaper() throws Exception {
        ...
        var homeActivityClass = TkkCore.getHomeActivityClass(classLoader);
...
//            if (TkkCore.ActivityChangeState.ChangeType.RESUMED == type && isHome) {
//                mContent = activity.findViewById(android.R.id.content);
//                if (mContent != null) {
//                    replaceColors(mContent, wallAlpha);
//                }
//            } else if (TkkCore.ActivityChangeState.ChangeType.CREATED == type && !isHome &&
...
//        });
    ...
    private boolean checkNotHomeActivity() {
        var homeClass = TkkCore.getHomeActivityClass(classLoader);
        var currentActivity = TkkCore.getCurrentActivity();
