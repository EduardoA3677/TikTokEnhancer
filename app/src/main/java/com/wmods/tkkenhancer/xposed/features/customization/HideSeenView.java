...
public class HideSeenView extends Feature {
    ...
    public void doHook() throws Throwable {
        ...
        XposedHelpers.findAndHookMethod(ListView.class, "setAdapter", ListAdapter.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                if (!TkkCore.getCurrentActivity().getClass().getSimpleName().equals("Conversation"))
                    return;
    ...
    public static void updateAllBubbleViews() {
        if (mAdapter instanceof CursorAdapter cursorAdapter) {
            TkkCore.getCurrentActivity().runOnUiThread(cursorAdapter::notifyDataSetChanged);
        }
    }

    @SuppressLint("ResourceType")
    private static void updateBubbleView(FMessageTkk fmessage, View viewGroup) {
