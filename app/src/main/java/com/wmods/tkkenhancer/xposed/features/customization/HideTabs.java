...
import static com.wmods.tkkenhancer.xposed.features.customization.SeparateGroup.tabs;
...
public class HideTabs extends Feature {
    ...
    public void doHook() throws Throwable {
        ...
        var home = TkkCore.getHomeActivityClass(classLoader);
        ...
        XposedHelpers.findAndHookMethod(TkkCore.getHomeActivityClass(classLoader), "onCreate", Bundle.class, new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                Class<?> TabsPagerClass = TkkCore.getTabsPagerClass(classLoader);
