...
import com.wmods.tkkenhancer.adapter.IGStatusAdapter;
import com.wmods.tkkenhancer.views.IGStatusView;
    ...
    public void doHook() throws Throwable {
        ...
        XposedBridge.hookMethod(getViewConversationMethod, new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                var mStatusContainer = new IGStatusView(TkkCore.getCurrentActivity());
        ...
        XposedBridge.hookAllConstructors(clazz2, new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                for (var mStatusContainer : mListStatusContainer) {
                    IGStatusAdapter mStatusAdapter = new IGStatusAdapter(TkkCore.getCurrentActivity(), statusInfoClass);
