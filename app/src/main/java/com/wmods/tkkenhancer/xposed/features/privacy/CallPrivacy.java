...
public class CallPrivacy extends Feature {
    ...
    public void doHook() throws Throwable {
        ...
        var clazzVoip = TkkCore.getVoipManagerClass(classLoader);
        ...
        XposedBridge.hookMethod(onCallReceivedMethod, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                Object callinfo;
                Class<?> callInfoClass = TkkCore.getVoipCallInfoClass(classLoader);
                ...
                Tasker.sendTaskerEvent(TkkCore.getContactName(userJid), userJid.getPhoneNumber(), "call_received");
        ...
        XposedBridge.hookAllMethods(TkkCore.getVoipManagerClass(classLoader), "nativeHandleIncomingXmppOffer", new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                var userJid = new FMessageTkk.UserJid(jidObj);
                var type = Integer.parseInt(prefs.getString("call_privacy", "0"));
    ...
    public boolean checkCallBlock(FMessageTkk.UserJid userJid, PrivacyType type) throws IllegalAccessException, InvocationTargetException {
        ...
        switch (type) {
            case ONLY_UNKNOWN:
                ...
                var contactName = TkkCore.getSContactName(userJid, true);
