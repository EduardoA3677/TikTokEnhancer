package com.wmods.tkkenhancer.xposed.utils;
...
import com.wmods.tkkenhancer.TkkXposed;
...
public class DesignUtils {
    ...
    public static void setReplacementDrawable(String name, Drawable replacement) {
        if (TkkXposed.ResParam == null) return;
        TkkXposed.ResParam.res.setReplacement(Utils.getApplication().getPackageName(), "drawable", name, new XResources.DrawableLoader() {
            @Override
    ...
    public static boolean isNightMode() {
        return TkkCore.getDefaultTheme() <= 0 ? isNightModeBySystem() : TkkCore.getDefaultTheme() == 2;
    }
